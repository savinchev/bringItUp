...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  var modulePgeSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    btns: '.next',
    container: '.moduleapp'
  });
  modulePgeSlider.render();
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          _this.postData(_this.path, formData).then(function (response) {
